...
enum GenericUsages	{ U_Joystick=0x4,U_Gamepad,U_X=0x30,U_Y,U_Z,U_Rx,U_Ry,U_Rz,U_Slider,U_Hat=0x39};				//		""
enum ButtonUsages	{ U_btnNone=0,U_btn1,U_btn2,U_btn3,U_btn4,U_btn5,U_btn6,U_btn7,U_btn8,U_btn9,U_btn10,U_btn11, U_btn12};	//		""
enum MainItemTags	{ Input=0x8,Collection=0xA,EndCollection=0xC};													//		""
enum GlobalItemTags	{ UsagePage,ReportSz=0x7,ReportId,ReportCnt,Push,Pop};											//		""
enum LocalItemTags	{ Usage=0,Usage_Min,Usage_Max};
enum CollTypes		{ Coll_Physical,Coll_Application,Coll_Locical,Coll_Report};
enum Report_items	{ Roll,Pitch,Yaw,Throttle,Hat,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,nJS_items};
